...
- (BOOL)application:(UIApplication *)application openURL:(NSURL *)url sourceApplication:(NSString *)sourceApplication annotation:(id)annotation
{
    ...
    else if ([[GMAuthShareEngine authShareEngine:GME_Third_App_Type_QQ] canHandleOpenURL:url]) // 腾讯APP
    {
        [[GMAuthShareEngine authShareEngine:GME_Third_App_Type_QQ] handleOpenURL:url];
    }
    else if ([[GMAuthShareEngine authShareEngine:GME_Third_App_Type_AP_Friend] canHandleOpenURL:url]) /// 支付宝朋友
    {
        [[GMAuthShareEngine authShareEngine:GME_Third_App_Type_AP_Friend] handleOpenURL:url];
    }
    else if ([[GMAuthShareEngine authShareEngine:GME_Third_App_Type_WeiBo] canHandleOpenURL:url]) // 新浪微博APP
    {
